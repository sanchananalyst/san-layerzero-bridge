...
outbound/inbound. Current unapplied planning profiles per direction and 24-hour
refill period are 500,000 SAN for the canary, 30,000,000 SAN for early public
operation, 50,000,000 SAN for normal operation, and 100,000,000 SAN for a later
mature profile. These are policy values, not live settings or launch
authorization, and none has been applied on mainnet.
